  ...
  return (
    <div className="pt-10 md:pt-20 pb-20 px-5 lg:px-10 flex flex-col gap-6" id="projects">
      ...
      <div className="flex items-center justify-center mt-8 md:mt-12">
        <div
          className="relative h-[250px] sm:h-[300px] lg:h-[450px] w-[600px] rounded-xl shadow-xl transition-all"
          style={{
        ...
        >
          <div
            className="border-2 border-zinc-400 overflow-hidden h-40 sm:h-44 lg:h-80 w-20 sm:w-24 lg:w-48 absolute bottom-0 right-[-20px] sm:right-[-25px] rounded-xl shadow-2xl"
            style={{
              backgroundImage: `url(${projectInfo[selectedNum - 1].image2})`,
              backgroundSize: "cover",
              backgroundPosition: "center",
              backgroundRepeat: "no-repeat",
            }}
