...
export default function Contact({ dark, setDark }) {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_45ts361', 'template_z8x4qop', form.current, {
        publicKey: 'lgcgoXlxhj_vYhNRj',
      })
      .then(
        () => {
    ...
    >
      ...
      <div className="flex items-center mt-5">
        ...
        <div className="lg:ml-4 flex w-full gap-8 md:w-auto justify-between md:justify-start items-center">
          <a href="https://www.linkedin.com/in/utkarshsarkari/" target="_blank">
            <img
          ...
          <a href="https://github.com/UtkarshSarkari" target="_blank">
            <img
              className={`h-7 hover:scale-110 transition-all cursor-pointer ${
                dark ? "invert" : ""
              }`}
          ...
          <a href="https://leetcode.com/utkrshsarkari/" target="_blank">
            <img
          ...
          <a href="https://utkrshsarkari@gmail.com" target="_blank">
            <img
              className="h-7 hover:scale-110 transition-all cursor-pointer"
              src={gmail}
              alt=""
          ...
          <a href="https://www.instagram.com/utkrshsarkari/" target="_blank">
            <img
